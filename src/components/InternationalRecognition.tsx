...
const InternationalRecognition = () => {
  return (
    <section className="relative w-full min-h-[600px] lg:min-h-[800px] bg-[#007A55] overflow-hidden flex items-center justify-center py-20" dir="rtl">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        <span className="text-[#CA8A04]">الاعتراف والتعاون الدولي</span>
        </h2>
...
<div className="mt-12">
  <button className="px-10 py-5 bg-[#CA8A04] hover:bg-white text-[#007A55] font-bold text-base md:text-lg rounded-full shadow-[0_10px_40px_rgba(238,180,34,0.4)] hover:shadow-[0_15px_50px_rgba(255,255,255,0.4)] hover:-translate-y-1 transition-all duration-300 tracking-wide uppercase cursor-pointer">
