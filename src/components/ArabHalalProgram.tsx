      ...
      <section className="relative z-10 py-16 px-6 md:px-12 flex-grow flex items-center">
        ...
        <div className="max-w-7xl mx-auto w-full">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
            ...
            {/* Reduced gap */}
            {/* Card 1 */}
            <div className="bg-white/5 backdrop-blur-md p-8 flex flex-col rounded-2xl border border-white/10 border-t-4 border-t-transparent hover:border-t-[#EEB422] shadow-[0_8px_30px_rgba(0,0,0,0.1)] hover:shadow-2xl hover:shadow-[#EEB422]/5 hover:-translate-y-1 transition-all duration-500 group">
              {" "}
              {/* Reduced padding */}
              ...
              <a
                href="#"
                className="mt-8 flex items-center gap-3 text-sm font-black tracking-wide text-white border-b-2 border-[#EEB422]/40 pb-1 hover:text-[#EEB422] hover:border-[#EEB422] transition-all w-fit leading-relaxed group/cta"
              >
                {" "}
            ...
            <div className="bg-white/5 backdrop-blur-md p-8 flex flex-col rounded-2xl border border-white/10 border-t-4 border-t-transparent hover:border-t-[#EEB422] shadow-[0_8px_30px_rgba(0,0,0,0.1)] hover:shadow-2xl hover:shadow-[#EEB422]/5 hover:-translate-y-1 transition-all duration-500 group">
              ...
              <div className="mt-8 flex flex-col gap-4">
                ...
                <a
                  href="#"
                  className="flex items-center gap-3 text-sm font-black tracking-wide text-white border-b-2 border-[#EEB422]/40 pb-1 hover:text-[#EEB422] hover:border-[#EEB422] transition-all w-fit leading-relaxed group/cta"
                >
                  {" "}
                  {/* Updated styling */}
                ...
                <a
                  href="#"
                  className="flex items-center gap-3 text-sm font-black tracking-wide text-slate-300 border-b border-white/20 pb-1 hover:text-white hover:border-[#EEB422]/50 transition-all w-fit leading-relaxed group/cta"
                >
                  {" "}
