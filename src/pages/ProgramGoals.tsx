      ...
      <section className="relative overflow-hidden bg-slate-950 py-16 lg:py-24">
        ...
        >
          ...
          <div className="mt-10 flex w-full flex-col justify-center gap-4 sm:w-auto sm:flex-row">
            <Link to="/program-scope" className="flex min-h-12 items-center justify-center rounded-xl bg-[#CA8A04] px-7 py-4 text-sm font-black text-slate-950 shadow-[var(--shadow-ind-floating)] hover:-translate-y-0.5">
              عرض مجالات التطبيق
            </Link>
