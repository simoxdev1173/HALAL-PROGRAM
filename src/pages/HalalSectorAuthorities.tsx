...
import { getHalalSectorAuthorities } from "../data/halalSectorAuthorities";
...
export default function HalalSectorAuthorities() {
  ...
  const authorities = getHalalSectorAuthorities(i18n.resolvedLanguage || i18n.language);
  const unavailable = isRtl ? "غير متوفر" : "Unavailable";
  ...
  return (
    <main className={`min-h-screen w-full max-w-full overflow-x-hidden bg-[#FAF9F6] ${isRtl ? "font-arabic" : "font-english"}`} dir={isRtl ? "rtl" : "ltr"}>
      <InnerPageHero
        title={`${isRtl ? "الجهات المعينة بقطاع الحلال في" : t("pages.authorities.titleBefore")} ${isRtl ? "الدول العربية" : t("pages.authorities.titleHighlight")}`}
        ...
        imageAlt={isRtl ? "الجهات المعينة بقطاع الحلال في الدول العربية" : `${t("pages.authorities.titleBefore")} ${t("pages.authorities.titleHighlight")}`}
      />
      <section className="relative py-16 lg:py-24">
        ...
        <div className="relative z-10 mx-auto max-w-[96rem] px-5 lg:px-6">
          <div className="mb-10 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <p className="max-w-5xl xl:text-nowrap text-sm font-bold leading-7 text-slate-600 lg:text-lg">
              {isRtl
                  ...
                  <div className="relative z-10 flex h-full w-full flex-col">
                    ...
                    <div className="mt-6 flex min-h-[315px] flex-col rounded-2xl border border-stone-100 bg-[#FAF9F6] p-5 shadow-[var(--shadow-ind-sharp)]">
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          <p className="text-xs font-black text-stone-500">{isRtl ? "الجهة المعينة في الحلال" : t("pages.authorities.authorityLabel")}</p>
