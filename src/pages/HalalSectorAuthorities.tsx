      ...
      <div className="relative z-10 flex h-full flex-col justify-between text-right">
        ...
        <div>
          ...
          <p className="mt-4 max-w-xl text-sm font-bold leading-7 text-stone-200">
            تعرف على شروط الانضمام إلى البرنامج وآلية تقديم الطلب ومراحل التقييم والاعتماد.
          </p>
    ...
    >
      ...
      <div className="relative z-10 flex h-full flex-col justify-between text-right">
        ...
        <div>
          ...
          <p className="mt-4 max-w-xl text-sm font-bold leading-7 text-stone-200">
            استعرض الدول العربية المنضمة إلى البرنامج ضمن منظومة الاعتراف المتعدد الأطراف.
          </p>
