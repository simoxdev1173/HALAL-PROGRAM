  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#FAF9F6] pt-24 font-arabic" dir="rtl">
      ...
      <section className="relative overflow-hidden bg-slate-950 px-6 py-16 lg:py-24">
        ...
        >
          <h2 className="text-3xl font-black leading-tight text-white lg:text-5xl">تابع مسار الانضمام</h2>
          <div className="mt-10 flex w-full flex-col justify-center gap-4 sm:flex-row">
            <Link to="/join-program" className="flex min-h-12 items-center justify-center rounded-xl bg-[#CA8A04] px-7 py-4 text-sm font-black text-slate-950 shadow-[var(--shadow-ind-floating)] hover:-translate-y-0.5">
              شروط الانضمام
            </Link>
            <Link to="/joined-countries" className="flex min-h-12 items-center justify-center rounded-xl border border-white/15 bg-white/10 px-7 py-4 text-sm font-black text-white shadow-[var(--shadow-ind-card)] backdrop-blur hover:bg-white hover:text-[#1C4C2A]">
              الدول المنضمة
            </Link>
          </div>
        </motion.div>
